...
# CSV出力
updated_nodes_df.to_csv(os.path.join(output_dir, "nodes_ln_test.csv"), index=False)
updated_edges_df.to_csv(os.path.join(output_dir, "edges_ln_test.csv"), index=False)
updated_channels_df.to_csv(os.path.join(output_dir, "channels_ln_test.csv"), index=False)

print("ぷよよーん！出力が完了したのりゃ！")
