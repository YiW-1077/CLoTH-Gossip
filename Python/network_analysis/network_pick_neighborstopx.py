...
df.to_csv("network_analysis/output/low_degree_neighbors_topx.csv", index=False, encoding="utf-8-sig")

print(f"ぷよよーん！上位{top_x}ノードに隣接する次数{degree}以下のノードを {len(df)} 件出力したのりゃ〜🎉")
